...
//Else
	...
	ElseIf at_Transaccion.SQLCode = 100 Then
		If Not CreaMovto(as_rut, ai_colacion, ad_fecha) Then
			...
			If ab_Mensaje Then
				//st_Mensaje.Text = "Código de Personal " + ls_rut + ", no ha sido Asignado al movimiento actual."
			End If
		Else	
			lb_Retorno	=	True
		End If	
	Else
		...
		If camv_estado <> 1 Then
			If camv_estado = 9 Then
				//st_Mensaje.Text = "La persona cuyo rut esta ingresando, ya efectuo el movto. correspondiente a este horario."
			End If
			lb_retorno	=	False
		End If
	End If
