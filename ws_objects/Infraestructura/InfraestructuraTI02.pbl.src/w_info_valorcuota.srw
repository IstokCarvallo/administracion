$PBExportHeader$w_info_valorcuota.srw
forward
global type w_info_valorcuota from w_para_informes
end type
type st_3 from statictext within w_info_valorcuota
end type
type st_4 from statictext within w_info_valorcuota
end type
type st_5 from statictext within w_info_valorcuota
end type
type st_2 from statictext within w_info_valorcuota
end type
type uo_selempresa from uo_seleccion_empresa within w_info_valorcuota
end type
type uo_selsucursal from uo_seleccion_sucursal within w_info_valorcuota
end type
type uo_selseccion from uo_seleccion_seccion within w_info_valorcuota
end type
type uo_selnroaca from uo_seleccion_nroaca within w_info_valorcuota
end type
type st_1 from statictext within w_info_valorcuota
end type
end forward
...
global w_info_valorcuota w_info_valorcuota

type variables

end variables

on w_info_valorcuota.create
int iCurrent
call super::create
...
type pb_excel from w_para_informes`pb_excel within w_info_valorcuota
integer x = 1856
integer y = 256
end type

type st_computador from w_para_informes`st_computador within w_info_valorcuota
end type

type st_usuario from w_para_informes`st_usuario within w_info_valorcuota
end type

type st_temporada from w_para_informes`st_temporada within w_info_valorcuota
end type

type p_logo from w_para_informes`p_logo within w_info_valorcuota
integer height = 292
string picturename = "\Desarrollo 17\Imagenes\Logos\RBlanco.jpg"
end type

type st_titulo from w_para_informes`st_titulo within w_info_valorcuota
integer width = 1431
string text = "Valor Cuota Equipos"
end type

type pb_acepta from w_para_informes`pb_acepta within w_info_valorcuota
integer x = 1943
integer y = 556
end type
...
istr_info.titulo	= "VALOR CUOTA EQUIPOS"
istr_info.copias	= 1

OpenWithParm(vinf, istr_info)
vinf.dw_1.DataObject = "dw_info_valorcuotaequipo"
...
type pb_salir from w_para_informes`pb_salir within w_info_valorcuota
integer x = 1943
integer y = 920
end type
