$PBExportHeader$uo_seleccion_cargo.sru
$PBExportComments$Objeto público para selección de cargo, Todas o Consolidada
forward
global type uo_seleccion_cargo from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_cargo
end type
type cbx_todos from checkbox within uo_seleccion_cargo
end type
type dw_seleccion from datawindow within uo_seleccion_cargo
end type
end forward
...
global uo_seleccion_cargo uo_seleccion_cargo
...
on uo_seleccion_cargo.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_cargos'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'carg_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'carg_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	MessageBox("Atención", "No existen Cargos en tabla respectiva")
