$PBExportHeader$uo_seleccion_proveedor.sru
$PBExportComments$Objeto público para selección de Proveedor, Todas o Consolidada
forward
global type uo_seleccion_proveedor from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_proveedor
end type
type cbx_todos from checkbox within uo_seleccion_proveedor
end type
type dw_seleccion from datawindow within uo_seleccion_proveedor
end type
end forward
...
global uo_seleccion_proveedor uo_seleccion_proveedor

type variables
DataWindowChild	idwc_Seleccion

uo_Proveedor	iuo_Codigo

Integer		Codigo, Pais, Region, Comuna
String			Nombre, Rut, Telefono, Correo, Contacto, Direccion, Giro
end variables
...
If iuo_Codigo.Existe(Integer(ai_Codigo), False, sqlca) Then
	...
	Correo			=	iuo_Codigo.Correo
	Contacto			=	iuo_Codigo.Contacto
...
on uo_seleccion_proveedor.create
...
on uo_seleccion_proveedor.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_proveedor'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'prov_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'prov_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	MessageBox("Atención", "No existen Proveedores en tabla respectiva")
...
ELSE
	...
	Codigo			=	-1
	Nombre			=	'Todas'
	iuo_Codigo		=	Create uo_Proveedor	
