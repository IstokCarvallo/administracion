$PBExportHeader$uo_seleccion_monedas.sru
$PBExportComments$Objeto público para selección de Sucursal, Todas o Consolidada
forward
global type uo_seleccion_monedas from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_monedas
end type
type cbx_todos from checkbox within uo_seleccion_monedas
end type
type dw_seleccion from datawindow within uo_seleccion_monedas
end type
end forward
...
global uo_seleccion_monedas uo_seleccion_monedas

type variables
DataWindowChild	idwc_Seleccion

uo_Monedas	iuo_Codigo

Integer		Codigo
String			Nombre, Abrevia, NombreIngles, Simbolo
end variables
...
on uo_seleccion_monedas.create
...
on uo_seleccion_monedas.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_monedas'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'mone_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'mone_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	MessageBox("Atención", "No existen Monedas en tabla respectiva")
