$PBExportHeader$uo_seleccion_paises.sru
$PBExportComments$Objeto público para selección de Sucursal, Todas o Consolidada
forward
global type uo_seleccion_paises from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_paises
end type
type cbx_todos from checkbox within uo_seleccion_paises
end type
type dw_seleccion from datawindow within uo_seleccion_paises
end type
end forward
...
global uo_seleccion_paises uo_seleccion_paises
...
on uo_seleccion_paises.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_pais'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'pais_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'pais_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	MessageBox("Atención", "No existen Paises en tabla respectiva")
