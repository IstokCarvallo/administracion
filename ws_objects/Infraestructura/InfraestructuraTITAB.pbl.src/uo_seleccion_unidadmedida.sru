$PBExportHeader$uo_seleccion_unidadmedida.sru
$PBExportComments$Objeto público para selección de Unidad de Medida, Todas o Consolidada
forward
global type uo_seleccion_unidadmedida from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_unidadmedida
end type
type cbx_todos from checkbox within uo_seleccion_unidadmedida
end type
type dw_seleccion from datawindow within uo_seleccion_unidadmedida
end type
end forward
...
global uo_seleccion_unidadmedida uo_seleccion_unidadmedida

type variables
DataWindowChild	idwc_Seleccion

uo_UnidadMedida	iuo_Codigo
...
on uo_seleccion_unidadmedida.create
...
on uo_seleccion_unidadmedida.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_unidadmedida'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'unme_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'unme_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	MessageBox("Atención", "No existen Unidades de Medida en tabla respectiva")
...
ELSE
	...
	Codigo			=	-1
	Nombre			=	'Todas'
	iuo_Codigo	=	Create uo_UnidadMedida
