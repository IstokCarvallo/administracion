$PBExportHeader$uo_seleccion_ubicacion.sru
$PBExportComments$Objeto público para selección de Ubicacion, Todas o Consolidada
forward
global type uo_seleccion_ubicacion from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_ubicacion
end type
type cbx_todos from checkbox within uo_seleccion_ubicacion
end type
type dw_seleccion from datawindow within uo_seleccion_ubicacion
end type
end forward
...
global uo_seleccion_ubicacion uo_seleccion_ubicacion

type variables
DataWindowChild	idwc_Seleccion

uo_Ubicacion iuo_Codigo
...
on uo_seleccion_ubicacion.create
...
on uo_seleccion_ubicacion.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_ubicacion'
...
ELSE
	...
	Codigo			=	-1
	Nombre			=	'Todas'
	iuo_Codigo		=	Create uo_Ubicacion
