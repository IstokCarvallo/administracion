$PBExportHeader$uo_seleccion_item.sru
$PBExportComments$Objeto público para selección de Item, Todas o Consolidada
forward
global type uo_seleccion_item from userobject
end type
type cbx_consolida from checkbox within uo_seleccion_item
end type
type cbx_todos from checkbox within uo_seleccion_item
end type
type dw_seleccion from datawindow within uo_seleccion_item
end type
end forward
...
global uo_seleccion_item uo_seleccion_item
...
on uo_seleccion_item.destroy
destroy(this.cbx_consolida)
destroy(this.cbx_todos)
destroy(this.dw_seleccion)
end on

event constructor;dw_Seleccion.Object.Codigo.Dddw.Name			=	'dw_mues_item'
dw_Seleccion.Object.codigo.Dddw.DisplayColumn	=	'item_nombre'
dw_Seleccion.Object.codigo.Dddw.DataColumn		=	'item_codigo'
...
IF	idwc_Seleccion.Retrieve() = 0 THEN
	MessageBox("Atención", "No existen Item's en tabla respectiva")
